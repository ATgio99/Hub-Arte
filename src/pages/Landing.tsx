...
export default function Landing() {
  ...
  const features = [
    { icon: "🖼️", title: "Catalogo opere", desc: "Schede dettagliate con immagini, analisi e innovazioni", href: "/opere" },
    { icon: "🕸️", title: "Grafo neuronale", desc: "Visualizza le connessioni tra opere, artisti e periodi in 3D", href: "/grafo" },
    { icon: "📅", title: "Timeline multilivello", desc: "Periodi, eventi e artisti su una linea del tempo navigabile", href: "/timeline" },
    { icon: "🗺️", title: "Mappa geografica", desc: "Esplora i luoghi che custodiscono le opere", href: "/mappa" },
    { icon: "🎯", title: "Quiz interattivo", desc: "Mettiti alla prova con 18 tipi di domanda generati dal dataset", href: "/test" },
    { icon: "📚", title: "Glossario", desc: "Termini tecnici e definizioni sempre a portata di mano", href: "/glossario" },
  ];
  ...
  return (
    <div className="wrap page" style={{ maxWidth: 900, margin: "0 auto", padding: "20px 18px 60px" }}>
      ...
      {/* Stats — 6 riquadri su una sola riga da desktop, 3+3 su due righe da mobile */}
      ...
      >
        ...
        `}</style>
        <div className="hubart-stats-grid" style={{
          display: "grid",
          gridTemplateColumns: "repeat(6, 1fr)",
          gap: 10,
          gridColumn: "1 / -1",
      ...
      {/* Features — card eleganti con bordo oro sottile, cliccabili */}
      <div style={{
        ...
        {features.map((f, i) => (
          ...
          >
            <Link
              to={f.href}
              style={{
                display: "block", padding: "24px 22px", background: "var(--bg)", border: "1px solid var(--line)",
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = "0 8px 24px -8px rgba(184,138,46,0.25)";
