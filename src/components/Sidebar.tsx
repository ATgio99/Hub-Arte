  ...
  return (
    <>
      ...
      <div className="sbx-top">
        <Link to="/" className="sbx-brand" data-testid="sbx-brand" onClick={onNavigate} aria-label="BASE Arte — home">
          {/* stella neurale dorata (logo BASE Arte) */}
          ...
          <span className="sbx-brand-txt">
            <b>BASE Arte</b><i>Storia dell'arte</i>
          </span>
        </Link>
