...
/** Come per i preferiti: uscendo da un account va svuotata anche la copia in
 *  memoria, altrimenti sopravvive al cambio di utente. */
export function azzeraStudiedLocali() {
