      ...
      case "luogo-input": {
        ...
        if (kind === "periodo-input") {
          ...
          return push({
            ...
            refHref: `/opera/${w.id}`,
            topicPeriodId: w.period_id,
            prompt: "A quale periodo storico appartiene quest'opera?",
            image: w.image_thumb || w.image_url,
            options: [],
            correct: 0,
        ...
        if (kind === "data-input") {
          ...
          return push({
            ...
            refHref: `/opera/${w.id}`,
            topicPeriodId: w.period_id,
            prompt: "A quando risale quest'opera?",
            image: w.image_thumb || w.image_url,
            options: [],
            correct: 0,
        ...
        if (kind === "luogo-input") {
          ...
          return push({
            ...
            refHref: `/opera/${w.id}`,
            topicPeriodId: w.period_id,
            prompt: "In quale città si trova quest'opera?",
            image: w.image_thumb || w.image_url,
            options: [],
            correct: 0,
