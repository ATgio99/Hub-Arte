...
Questo documento contiene **tutte le informazioni** per richiedere il Netlify Open Source Plan per il progetto Base Arte.
...
1. **Licenza OSI-approved** — Il progetto deve avere una licenza approvata dalla Open Source Initiative (MIT, Apache 2.0, GPL, ecc.). Base Arte usa **MIT** ✓
...
| **Project name** | `Base Arte — Atlante di storia dell'arte` |
...
```
Base Arte — Atlante di storia dell'arte è un atlante digitale open source di Storia dell'Arte
